...
export const multiversalMishapsActualUsers = pgTable(
  "multiversal-mishaps_actual_users",
  {
  ...
  (table) => {
    return {
      multiversalMishapsActualUsersUsernameUnique: unique(
        "multiversal-mishaps_actual_users_username_unique",
      ).on(table.username),
      multiversalMishapsActualUsersEmailUnique: unique(
...
export const multiversalMishapsDeck = pgTable(
  "multiversal-mishaps_deck",
  {
    id: varchar("id", { length: 255 }).primaryKey().notNull(),
...
export const multiversalMishapsMatch = pgTable(
  "multiversal-mishaps_match",
  {
    id: varchar("id", { length: 255 }).primaryKey().notNull(),
    name: varchar("name", { length: 255 }),
    password: varchar("password", { length: 255 }),
    allQuestions: varchar("all_questions", { length: 2000 })
      .array()
      .default([""])
      .notNull(),
  ...
  (table) => {
    return {
      multiversalMishapsMatchDeckMultiversalMishapsDeckIdFk: foreignKey({
        ...
        .onUpdate("cascade")
        .onDelete("cascade"),
      multiversalMishapsMatchNameUnique: unique(
...
export const multiversalMishapsPlayer = pgTable(
  "multiversal-mishaps_player",
  {
    id: varchar("id", { length: 255 }).primaryKey().notNull(),
    username: varchar("username", { length: 255 }).notNull(),
...
export const multiversalMishapsQuestion = pgTable(
  "multiversal-mishaps_question",
  {
    id: varchar("id", { length: 255 }).primaryKey().notNull(),
